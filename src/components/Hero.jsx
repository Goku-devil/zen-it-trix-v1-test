    ...
    return (
        <section className="hero" id="top">
            <div className="hero-copy">
                <p className="eyebrow department-label">Department of Information Technology</p>
            ...
            <div className="hero-art" aria-label="Zen-it-trix 2.0 event details">
                ...
                <div className="burst burst-one">THINK<br />LOUD</div>
                <div className="burst burst-two">PLAY<br />HARD</div>
