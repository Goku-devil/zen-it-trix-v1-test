...
export default function Hero() {
    return (
        <section className="hero" id="top">
            <div className="hero-copy"><p className="eyebrow department-label">Department of Information Technology</p><div className="hero-event-name"><span>presents</span><strong>Zen-IT-Trix <b>2.0</b></strong></div><p className="hero-text">A day where sharp minds, wild ideas, and good people collide. Come for the challenge. Stay for the energy.</p><div className="hero-actions"><a className="primary-button" href="#events">See all events <span>↓</span></a><a className="register-button" href={register_link} target="_blank" rel="noreferrer">Register now <span>↗</span></a></div></div>
